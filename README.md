...
OnixGPT is a lightweight, fine-tuneable GPT framework designed for financial text modeling and agent workflows in the Troyonix AI wealth management platform. Built on [nanoGPT](https://github.com/karpathy/nanoGPT), it is optimized for Apple Silicon (M1/M2) with torch-metal support, and is ready for local training and future FastAPI API serving.
